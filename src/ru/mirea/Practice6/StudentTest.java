...
public class StudentTest {
    public static void main(String[] args) {
        ...
        System.out.println();
        System.out.println("Sort students by ID:");// Вставки по id
        Student temp;
        ...
        System.out.println("Sort students by GPA:");// Быстрая по GPA
        for (Student s : students) {
            System.out.println(s);
        }
        System.out.println();
        ...
        System.out.println("Combined students by ID:");// merge sort
